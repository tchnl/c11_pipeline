...
def main():
    for i in range(4):
        ...
        subprocess.call("cd /sharing/students/meme/bin/ ; ./meme "+str(MEME_input)+" -oc /home/thierry/c11_pipeline/output"+str(i)+"/ -nostatus -time 18000 -maxsize 60000 -mod zoops -nmotifs 3 -minw 35 -maxw 45 ", shell=True)    
